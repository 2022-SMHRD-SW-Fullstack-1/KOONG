	...
	public static void main(String[] args) {
		...
		while (true) { // 메인화면
			...
			System.out.println(
					...
					+ "|  |--..-----.|  ||  |.-----. |  |--..-----..-----..-----..-- --..-----..-- .-. |  |\r\n"
					+ "|     ||  -__||  ||  ||  _  | |    < |  _  ||  _  ||     || |_| ||  |  || |_| | |__|\r\n"
					+ "|__|__||_____||__||__||_____| |__|__||_____||_____||__|__||___  ||___  ||___._| |__|\r\n"
					+ "                                                          |_____||_____|                   ");
//			System.out.println(
//					  "⠀            ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀ ⠀  ⠀ ⠀⢀⣤⣤⠀⠀⠀⠀⠀⣠⣤⣄⠀⠀⠀⠀⠀⠀\r\n"
//					+ "⠀            ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀   ⠀⠀⠀⣿⣿⣿⣷⡀⠀⠀⣼⣿⣿⣿⡆⠀⠀⠀⠀⠀\r\n"
...
//					+ "");
			...
			if (select == 1) {
				...
				if (result > 0) {
					System.out.println("=====================================================================================");
					System.out.println("Ｏ _ Ｏ\t\t 가입 완료!! 환영합니다 \t\tＯ _ Ｏ ");
					System.out.println("=====================================================================================");
				} else {
				
					System.out.println("\t ·°( ˃ᗝ˂ )°· \t\t  가입에 실패했어요  \t\t\t ·°( ˃ᗝ˂ )°· ");
					System.out.println("=====================================================================================");
				}
			}
		}
		...
		while(true) {
			...
			if(select==1) {
				...
				System.out.println("=====================================================================================");
				System.out.println("\t\t(^_^) \t\t  다음에 또 봐요! \t\t (^_^) ");
				System.out.println("=====================================================================================");
